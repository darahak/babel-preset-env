...
export default function buildPreset(context, opts = {}) {
  ...
  const pluginOptions = {
    debug,
    polyfills,
    regenerator: transformations.has("transform-regenerator"),
  };

  if (useBuiltIns === true) {
    plugins.push([addUsedBuiltInsPlugin, pluginOptions]);
  } else if (useBuiltIns === "entry") {
    plugins.push([useBuiltInsEntryPlugin, pluginOptions]);
  }
